...
public static class DefaultCategories
{
    ...
    [
        ...
        new("Monthly Household Bills", "Mortgage & Rent", ["apartments", "mortgage"], 3, 0m, 3),
        new("Monthly Household Bills", "Utilities", ["utility", "gas", "electric", "water", "smud", "pge"], 4, 0m, 4),
        new("Monthly Household Bills", "Phone", ["verizon", "metropcs", "mobile"], 5, 0m, 5),
        new("Monthly Household Bills", "Internet, Cable, Satellite", ["internet", "comcast", "xfinity", "at&t", "cable", "satellite"], 6, 0m, 6),
